        ...
        <section class="form-content">
            ...
            <div class="row">
                ...
                <!-- <form class="form" method="post" action="https://sandbox.payhere.lk/pay/checkout"> -->
                    <form class="form" method="post" action="<?php echo $localhost; ?>Payment/pay2">
                        ...
                        <div class="inputBox">
                            <input type="text" name="order_id" value="<?php echo $this->item[0][0]; ?>">
                            <input type="hidden" id="items" name="items" value="<?php echo $this->item[0][1]; ?>" placeholder="Enter Item name">
                            <input type="text" id="item_name_1" name="item_name_1" value="<?php echo $this->item[0][1]; ?>">
                        </div>
                        <div class="inputBox">
                            <input type="number" class="quantity" name="quantity_1" value="<?php echo $this->item[0][2]; ?>" min="<?php echo $this->item[0][2]; ?>" max="<?php echo $this->item[0][2]; ?>" placeholder=" Enter qty">
                            <input class="amount_1" type="text" name="amount_1" value="<?php echo $this->item[0][2]; ?>">
                        </div>
                        <h3>Total price</h3>
                        <div class="inputBox">
                            <input type="text" name="currency" value="LKR">
                            <input class="amount" type="text" name="amount" value="<?php echo $this->item[0][7]; ?>">
                        </div>
