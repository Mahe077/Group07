            ...
            <div class="row">
                ...
                <!-- <form class="form" method="post" action="<?php echo $localhost; ?>Payment/pay"> -->
                    ...
                    <div class="inputBox">
                        ...
                        <input type="number" class="quantity_1" name="quantity_1" value="1" min="1" max="100" placeholder=" Enter quantity" onchange="changeprice(1,1)">
                    ...
                    <div class="inputBox">
                        ...
                        <input type="tel" name="phone" pattern="[0-9]{10}" value="<?php echo $_SESSION['contact']; ?>" required > 
                    </div>
                    <div class="inputBox">
